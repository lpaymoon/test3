...
public class MerReferCacheHelper  extends DefaultCacheHelper{

	/**
	 * @param dal
	 */
	public MerReferCacheHelper(CommonDalInf dal) {
		super(dal);
	...
	public Object getDataFromDB(Map<String, String> map) throws Exception {
		...
		List<Map<String, Object>> rs = dal.find("psql_MERREFERREST.getMerRefer", map);
