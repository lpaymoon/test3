...
public class upPayCase extends Base{
	...
	public void testDoCreateService() throws Exception {
		...
		m.put(HFBusiDict.ORDERID,"111526986047046");//主键
		...
		m.put(HFBusiDict.AMOUNT, "100");
		m.put(HFBusiDict.MERCUSTID, "45");
		m.put(HFBusiDict.BUSINESSTYPE, "0601");
		m.put(HFBusiDict.MERPRIV,"test");
		m.put(HFBusiDict.EXPAND,"test");
		m.put(HFBusiDict.AMTTYPE,"03");
		m.put(HFBusiDict.VERSION,"1.0");
		m.put(HFBusiDict.RPID,"test123000799008");
		m.put("sdktype","1");
		m.put("sdkversion","1.0");

		System.out.println("orderid="+orderid+",porderid="+porderid);
		Map map = (Map) api.doCall("POST", "/uprestbusi/UpPayRest/test2" + getRandomNum(1) +"3999778/"+orderid+".xml", m, Map.class);
