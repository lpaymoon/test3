 ...
 * @see        :                         
 * ***********************************************/
public class R4PayTest extends Base{
...
//			r4PayTest();
	 ...
	 * @see          :  
	 * ***********************************************/
	public static void r4PayTest() throws Exception{
...
//		System.out.println(map.get("MMURL"));
	...
	public static Map<String, Object> testMMSms() throws Exception{
		...
		argsMap.put(HFBusiDict.ORDERID, "8372170");
		...
		argsMap.put(HFBusiDict.BUSINESSTYPE, "0611");
		argsMap.put(HFBusiDict.PLATORDID, "20140925165813999600000000006010");
...
//		Object rs = HTTPSendUtil.getHttpResPost_Form("http://10.10.38.214:8690/uprestbusi/branch/0601/frdfjltest/bs.xml", argsMap);
		Object rs = HTTPSendUtil.getHttpResPost_Form("http://10.10.38.214:8690/uprestbusi/UpPayRest/fr7f86841409/bs.xml", argsMap);
